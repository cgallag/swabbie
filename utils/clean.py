...
class Clean(object):
    ...
    def _summary(cls, change_report, obj_name):
        if change_report.start > 0:
            ...
            click.echo(removed + remaining)
        else:
            click.echo('No {} were found.\n'.format(obj_name))
